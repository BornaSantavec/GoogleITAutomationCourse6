...
for text_file in os.listdir(supplier_desc_path):
...
if __name__ == "__main__":
    ...
    reports.generate_report method: the text description processed from the
    text files as the paragraph argument, the report title as the title
    argument, and the file path of the PDF to be generated as the attachment
    argument (use ‘/tmp/processed.pdf')
    """
    summary = process_data(text_data)
    # Generate a paragraph with summary
    ...
    Use the following details to pass the parameters to emails.generate_email():
        ...
        Replace username with the username given in the Connection Details
         Panel on the right hand side.
        Subject line: Upload Completed - Online Fruit Store
        E-mail Body: All fruits are uploaded to our website successfully. A
